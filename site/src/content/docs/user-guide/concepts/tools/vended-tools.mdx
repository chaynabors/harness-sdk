...
to change something that already exists. See the file-write recommendation README
([Python](https://github.com/strands-agents/harness-sdk/blob/main/strands-py/src/strands/vended_tools/file_write/README.md),
[TypeScript](https://github.com/strands-agents/harness-sdk/blob/main/strands-ts/src/vended-tools/file-write/README.md))
