...
durations and fake clocks so the suite never actually blocks for a second, and
verify that input validation, the configurable cap, and cooperative
cancellation all behave.
"""
...
class TestHappyPath:
    ...
    async def test_zero_duration_returns_immediately(self):
        ...
        assert result == "Slept for 0.0 seconds"
